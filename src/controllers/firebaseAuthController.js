...
module.exports = {
  showLogin: (req, res) => {
    res.render('auth/login', { title: 'Login', error: null, email: '', firebaseConfig: getClientConfig() });
  },
  showRegister: (req, res) => {
    res.render('auth/register', { title: 'Register', error: null, email: '', firebaseConfig: getClientConfig() });
  },
