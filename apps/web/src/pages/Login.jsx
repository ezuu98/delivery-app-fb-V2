    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="aux-links">
          {mode !== 'login' && <a className="muted-link" href="#" onClick={(e) => { e.preventDefault(); setMode('login'); setMessage(''); setError(''); }}>Have an account? Sign in</a>}
          {mode !== 'signup' && <a className="muted-link" href="#" onClick={(e) => { e.preventDefault(); setMode('signup'); setMessage(''); setError(''); }}>Create account</a>}
          {mode !== 'reset' && <a className="muted-link" href="#" onClick={(e) => { e.preventDefault(); setMode('reset'); setMessage(''); setError(''); }}>Forgot password?</a>}
          {mode !== 'otp' && <a className="muted-link" href="#" onClick={(e) => { e.preventDefault(); setMode('otp'); setMessage(''); setError(''); }}>Use OTP</a>}
        </div>
      </div>
    </div>
  );
